...
const pathToDstFileFolder = './db/dst/yandex/';

// путь к каталогу с отчетами
const pathToReportFolder = './db/reports/errors/yandex/';
// const pathToReportFolder = './db/reports/errors/wooordhunt/';
...
(async () => {
  try {
    ...
    // остальные непредвиденные ошибки
    console.log(`Unexpected error! stack: '${err.stack}'`);
  }
})();
